var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-tnzunw");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "class", "progress-container svelte-tnzunw");
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.jpeg" alt="How to wash our hands" class="svelte-1yc2abm"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
